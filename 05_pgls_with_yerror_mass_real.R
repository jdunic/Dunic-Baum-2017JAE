...
# Gape height
all_spp_summ_df_gh <- merge(fam_lookup, boot_spp_summary_gh_mass, 
...
# Gape height
all_spp_summ_df_gw <- merge(fam_lookup, boot_spp_summary_gw_mass, 
                         by.x = 'SpeciesCode', by.y = 'group')
...
spp_err_iso_gh <- glht(fit.gls_gh, linfct = c('fgPi = 0.33', 
                                              'fgBI = 0.33', 
                                              'fgZP = 0.33', 
                                              'fgHe = 0.33'))#, 
                                              #'fgC  = 0.33'))
...
spp_err_iso_gw <- glht(fit.gls_gw, linfct = c('fgPi = 0.33', 
                                              'fgBI = 0.33', 
                                              'fgZP = 0.33', 
                                              'fgHe = 0.33'))#, 
                                              #'fgC  = 0.33'))
