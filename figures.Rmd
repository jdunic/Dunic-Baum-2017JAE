...
Weird missing confidence intervals for ZP and He :(
...
sp_name_by_slope <- 
    c("Lutjanus bohar", "Variola louti", "Cephalopholis urodeta", 
      ...
      "Centropyge flavissima", "Chlorurus sordidus", "Acanthurus nigricans", 
...
mk_multipanel_plots_mass(fg_point_df = p, spp_point_df = p_spp_dfs$AP.FURC, 
    ...
    geom_abline(slope = 1/3, intercept = all_fg_GH_graph_df$ref_intercept_iso[1], linetype = 2, colour = "darkgrey") + 
    ...
    geom_abline(slope = all_fg_GH_graph_df[1, ]$lme_slope, 
                intercept = all_fg_GH_graph_df[1, ]$lme_ref_int, colour = 'red', alpha = 0.4) 
luboha <- 
...
mk_multipanel_plots_mass(fg_point_df = b, spp_point_df = b_spp_dfs$PA.ARCA, 
    ...
    geom_text(data = allGH_bySPP_graph_df[7, ], aes_string(x = 45, y = 60, 
        label = 'allometry'), parse = TRUE, size = 3, hjust = 1) + 
    geom_abline(slope = all_fg_GH_graph_df[2, ]$lme_slope, 
                intercept = all_fg_GH_graph_df[2, ]$lme_ref_int, colour = 'red', alpha = 0.4)
painsu <-
...
mk_multipanel_plots_mass(fg_point_df  = z, spp_point_df  = z_spp_dfs$PS.BART, 
    ...
    geom_text(data = allGH_bySPP_graph_df[13, ], aes_string(x = 9.7, y = 25, 
        label = 'allometry'), parse = TRUE, size = 3, hjust = 1) + 
    geom_abline(slope = all_fg_GH_graph_df[3, ]$lme_slope, 
                intercept = all_fg_GH_graph_df[3, ]$lme_ref_int, colour = 'red', alpha = 0.4)
catere <-
...
mk_multipanel_plots_mass(fg_point_df = h, spp_point_df = h_spp_dfs$AC.NIGR, 
    ...
    geom_text(data = allGH_bySPP_graph_df[16, ], aes_string(x = 106, y = 50, 
        label = 'allometry'), parse = TRUE, size = 3, hjust = 1) + 
    geom_abline(slope = all_fg_GH_graph_df[4, ]$lme_slope, 
                intercept = all_fg_GH_graph_df[4, ]$lme_ref_int, colour = 'red', alpha = 0.4)
ceflav <-
...
The prey size - predator mass size works... weight was coded as a factor :|
