...
```{r, echo=FALSE, fig.height = 6, fig.width = 8, fig.cap = '(a) Absolute gape height (mm) and (b) relative gape height, calculated as gape height (mm) / standard length (mm) for all species ordered within each functional group by decreasing absolute gape height. A single outlier (64 mm) for *Cephalopholis argus* is not shown.'}
...
```{r, echo=FALSE, fig.height=8, fig.width=7, fig.cap='Gape height ~ standard length relationships for the (a) six zooplanktivores and (b) six energy$-$sharing herbivorous and detritivorous species, in order of increasing slope. Plot details are the same as in Figure 4.'}
# With "Figure" label
master_layout <- 
